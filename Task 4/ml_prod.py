...
def load_data(path: str='C:/Users/HP/Documents/Gala Groceries Project/Data/sales.csv'):
    """Load the CSV file into a Pandas DataFrame and drop unnecessary column.

    Args:
        path (str): Path to csv file. Defaults to 'C:/Users/HP/Documents/Gala Groceries Project/Data/sales.csv'.
...
def load_model(path: str='C:/Users/HP/Documents/Gala Groceries Project/Task 4/final_model.pkl'):
    """Load the model from a pickle file.

    Args:
        path (str): Path to pickle file containing the model object. Defaults to 'C:/Users/HP/Documents/Gala Groceries Project/Task 4/final_model.pkl'.
